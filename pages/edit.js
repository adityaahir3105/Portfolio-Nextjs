      ...
      <div className="mt-10">
        ...
        {currentTabs === "RESUME" && (
          <div className="mt-10">
            ...
            <div className="mt-10">
              <div className="flex">
                <label className="w-1/5 text-lg opacity-50">frontend</label>
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.resume.frontend.map((language, index) => (
                            ...
                            onChange={(e) => {
                              setData({
                                ...
                                resume: {
                                  ...data.resume,
                                  frontend: [
                                    ...data.resume.frontend.slice(0, index),
                                    e.target.value,
                                    ...data.resume.frontend.slice(index + 1),
                                  ],
                                },
                              });
                            }}
                        ...
                        <Button
                            onClick={() =>
                                setData({
                                  ...
                                  resume: {
                                    ...data.resume,
                                    frontend: data.resume.frontend.filter(
                                        (value, i) => index !== i
                                    ),
                                  },
                                })
                  ...
                  <Button
                      ...
                      onClick={() =>
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              frontend: [...data.resume.frontend, "Added"],
                            },
                          })
                      }
                  >
              ...
              <hr className="my-10"></hr>
              <div className="flex">
                <label className="w-1/5 text-lg opacity-50">Backend</label>
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.resume.backend.map((framework, index) => (
                      <div key={index} className="flex">
                        <input
                            value={framework}
                            onChange={(e) => {
                              setData({
                                ...
                                resume: {
                                  ...data.resume,
                                  backend: [
                                    ...data.resume.backend.slice(0, index),
                                    e.target.value,
                                    ...data.resume.backend.slice(index + 1),
                                  ],
                                },
                              });
                            }}
                        ...
                        <Button
                            onClick={() =>
                                setData({
                                  ...
                                  resume: {
                                    ...data.resume,
                                    backend: data.resume.backend.filter(
                                        (value, i) => index !== i
                                    ),
                                  },
                                })
                  ...
                  <Button
                      onClick={() =>
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              backend: [...data.resume.backend, "Added"],
                            },
                          })
                      }
                      type="primary"
              ...
              <hr className="my-10"></hr>
              <div className="flex">
                <label className="w-1/5 text-lg opacity-50">cicd</label>
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.resume.cicd.map((other, index) => (
                      <div key={index} className="flex">
                        <input
                            value={other}
                            onChange={(e) => {
                              setData({
                                ...
                                resume: {
                                  ...data.resume,
                                  cicd: [
                                    ...data.resume.cicd.slice(0, index),
                                    e.target.value,
                                    ...data.resume.cicd.slice(index + 1),
                                  ],
                                },
                              });
                            }}
              ...
              <hr className="my-10"></hr>
              <div className="flex">
                <label className="w-1/5 text-lg opacity-50">dbmsAndDataPipelines</label>
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.resume.dbmsAndDataPipelines.map((other, index) => (
                      <div key={index} className="flex">
                        <input
                            value={other}
                            onChange={(e) => {
                              setData({
                                ...
                                resume: {
                                  ...data.resume,
                                  dbmsAndDataPipelines: [
                                    ...data.resume.dbmsAndDataPipelines.slice(0, index),
                                    e.target.value,
                                    ...data.resume.dbmsAndDataPipelines.slice(index + 1),
                                  ],
                                },
                              });
                            }}
                        ...
                        <Button
                            onClick={() =>
                                setData({
                                  ...
                                  resume: {
                                    ...data.resume,
                                    dbmsAndDataPipelines: data.resume.dbmsAndDataPipelines.filter(
                                        (value, i) => index !== i
                                    ),
                                  },
                                })
                  ...
                  <Button
                      onClick={() =>
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              dbmsAndDataPipelines: [...data.resume.dbmsAndDataPipelines, "Added"],
                            },
                          })
                      }
                      type="primary"
              ...
              <hr className="my-10"></hr>
              <div className="flex">
                <label className="w-1/5 text-lg opacity-50">testingFrameWorks</label>
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.resume.testingFrameWorks.map((other, index) => (
                      <div key={index} className="flex">
                        <input
                            value={other}
                            onChange={(e) => {
                              setData({
                                ...
                                resume: {
                                  ...data.resume,
                                  testingFrameWorks: [
                                    ...data.resume.testingFrameWorks.slice(0, index),
                                    e.target.value,
                                    ...data.resume.testingFrameWorks.slice(index + 1),
                                  ],
                                },
                              });
                            }}
                        ...
                        <Button
                            onClick={() =>
                                setData({
                                  ...
                                  resume: {
                                    ...data.resume,
                                    testingFrameWorks: data.resume.testingFrameWorks.filter(
                                        (value, i) => index !== i
                                    ),
                                  },
                                })
                  ...
                  <Button
                      onClick={() =>
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              testingFrameWorks: [...data.resume.testingFrameWorks, "Added"],
                            },
                          })
                      }
                      type="primary"
